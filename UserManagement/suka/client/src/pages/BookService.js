              ...
              <div className="card">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-primary-600 font-medium capitalize">{selectedService.category}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600">Base Price:</span>
                    <span className="text-green-600 font-semibold">LKR {selectedService.basePrice}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-gray-900">{selectedService.estimatedDuration}</span>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="form-group">
                      ...
                      {errors.scheduledTime && (
                        <p className="form-error">{errors.scheduledTime.message}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    ...
                    >
                      {submitting ? (
                        ...
                        'Cannot Book - Materials Loading Failed'
                      ) : (
                        'Book Service Now'
                      )}
                    </button>
