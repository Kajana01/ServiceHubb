...
const notificationSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    required: true,
    enum: ['booking_created', 'booking_assigned', 'booking_started', 'booking_completed', 'booking_cancelled', 'feedback_received', 'announcement', 'inventory_alert', 'payment_reminder']
  },
  title: {
    type: String,
    required: true,
