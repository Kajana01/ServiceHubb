      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl h-[90vh] flex flex-col">
        ...
        <div className="flex-1 flex">
          ...
          <div className="flex-1 p-4">
            <div className="h-full rounded-lg border-2 border-gray-300 overflow-hidden">
                      ...
                      <Marker
                        ...
                        icon={{
                          ...
                          scaledSize: window.google && window.google.maps ? 
                            new window.google.maps.Size(32, 32) : undefined
                        }}
                      >
                        {showInfoWindow && (
                          <InfoWindow
                    ...
                    {popularCities.map((city) => (
                      <Marker
                        ...
                        icon={{
                          ...
                          scaledSize: window.google && window.google.maps ? 
                            new window.google.maps.Size(24, 24) : undefined
                        }}
                        onClick={() => handleCitySelect(city)}
                      />
                    ))}
